...
public class SprintingState : ICharacterState
{
    private CharacterMovement character;

    public SprintingState(CharacterMovement character)
    {
    ...
    public void Update()
    {
        ...
        Vector3 horizontalMove = (cameraForward * character.InputDirection.z + cameraRight * character.InputDirection.x).normalized * character.Resources.runSpeed;
